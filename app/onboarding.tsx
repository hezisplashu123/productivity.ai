...
import { Check, Flame, MessageCircle, Sparkles, X, ArrowRight, Hand, CornerDownLeft, CornerDownRight, RotateCcw, Layers } from 'lucide-react-native';
import { Gesture, GestureDetector } from 'react-native-gesture-handler';
import Animated, { cancelAnimation, Easing, Extrapolate, interpolate, runOnJS, useAnimatedStyle, useSharedValue, withRepeat, withSequence, withSpring, withTiming, FadeIn, FadeOut, SlideInDown, SlideOutDown } from 'react-native-reanimated';
...
const TUTORIAL_STEPS = [
  { id: 'tutorial-right', question: 'What is your favorite season of the year?', guidance: "Don't like a question?\nSwipe right to skip.", expectedAction: 'right' as const },
  { id: 'tutorial-left', question: 'What is a movie you could watch over and over again?', guidance: 'Fits the vibe?\nSwipe left to answer.', expectedAction: 'left' as const },
...
export default function OnboardingScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <Animated.View style={styles.introContainer} entering={FadeIn} exiting={FadeOut}>
          ...
          <View style={styles.bigRulesContainer}>
            ...
            <View style={styles.bigRuleCard}>
              ...
              <Text style={styles.bigRuleDesc}>The deck starts light. As you swipe left to answer, the AI pulls you gradually deeper.</Text>
            </View>
          </View>
      ...
      {phase === 1 && (
        <Animated.View style={styles.demoWrapper} entering={FadeIn.duration(400)}>
          ...
          <View style={styles.bottomSection} pointerEvents="none">
            <View style={styles.hintContainer}>
              <View style={styles.hintPill}><CornerDownLeft size={16} color={theme.success} /><Text style={[styles.hintTitle, { color: theme.success }]}>Answer</Text></View>
              ...
              <View style={styles.hintPill}><Text style={[styles.hintTitle, { color: theme.error }]}>Skip</Text><CornerDownRight size={16} color={theme.error} /></View>
            </View>
          </View>
        </Animated.View>
      )}
...
const getStyles = (theme: Theme) => StyleSheet.create({
  ...
  discussionOverlay: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(0, 0, 0, 0.96)', zIndex: 100 },
